// Simple SVG icons to replace emojis throughout the app
// Each icon is a 1em-sized inline SVG
...
export function WalkIcon({ className = '' }) {
  return (
    <svg className={className} width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M7 21l3-7 2.5 2v5" />
      <path d="M10 14l-2-2 4-4 3 3-2 4" />
    </svg>
  );
}
...
export function FerryIcon({ className = '' }) {
  return (
    <svg className={className} width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 20c2-1 4-1 6 0s4 1 6 0 4-1 6 0" />
      <path d="M4 18l2-14h12l2 14" />
      <path d="M12 4v4" />
      <path d="M8 8h8" />
    </svg>
  );
...
export function TaxiIcon({ className = '' }) {
  return (
    <svg className={className} width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M5 17h14" />
      <path d="M6 11l2-5h8l2 5" />
